          ...
          <div className="rounded-lg border border-neutral-200 bg-white">
            ...
            <div className="border-b border-neutral-100 p-4">
              ...
              <select
                ...
                className="w-full max-w-full cursor-pointer rounded-md border border-neutral-300 bg-white px-3 py-2 text-sm text-neutral-900 transition-colors hover:border-neutral-400 focus:border-[#1B5E20] focus:outline-none focus:ring-1 focus:ring-[#1B5E20]"
